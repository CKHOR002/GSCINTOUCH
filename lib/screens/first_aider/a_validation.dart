...
class AValidation extends StatefulWidget {
  const AValidation({Key? key}) : super(key: key);

  static const String id = 'AValidation';

  @override
  State<AValidation> createState() => _AValidationState();
}

class _AValidationState extends State<AValidation> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          PFARequirement(
              requirementText: 'Answer 2 of the references correctly.',
              isValidate:
                  Provider.of<PFA1RequirementData>(context).requirement_1!),
          // Answer: Integrity of physical health / Physical safety / Psychophysiological distress / Cognitive and intellectual functioning / Affective and behavioral expression / Interpersonal resources / Material resources
        ],
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            '1) What are some of the references that we can draw to assist in answering the 3 key questions in screening? List any 2 of them.',
            style: TextStyle(
              fontSize: 14.0,
