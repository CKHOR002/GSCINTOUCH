...
class PValidation extends StatefulWidget {
  const PValidation({Key? key}) : super(key: key);

  static const String id = 'PValidation';

  @override
  State<PValidation> createState() => _PValidationState();
}

class _PValidationState extends State<PValidation> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          PFARequirement(
              requirementText: 'Answer 2 of the criteria correctly.',
              isValidate:
                  Provider.of<PFA1RequirementData>(context).requirement_1!),
          //Answer: Medical crises / Maslovian physical needs / Safety / Psychological/behavioral instability / Predictors of posttraumatic illness/dysfunction /
        ],
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            '1) How do we consider if survivors/patients are in need of urgent/higher-priority attention? List 2 of the ways.',
            style: TextStyle(
              fontSize: 14.0,
