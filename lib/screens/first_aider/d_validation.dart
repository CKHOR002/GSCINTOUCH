...
class DValidation extends StatefulWidget {
  const DValidation({Key? key}) : super(key: key);

  static const String id = 'DValidation';

  @override
  State<DValidation> createState() => _DValidationState();
}

class _DValidationState extends State<DValidation> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          PFARequirement(
              requirementText: 'Need a follow-up',
              isValidate:
                  Provider.of<PFA1RequirementData>(context).requirement_1!),
          //Answer: Yes
          PFARequirement(
              requirementText: 'Timing of follow-up',
              isValidate:
                  Provider.of<PFA1RequirementData>(context).requirement_2!),
          //Answer: Follow up at a time deemed most appropriate
        ],
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            '1) If after your intervention, Bob is still feeling anxious, does he need a follow-up? If yes, when should be the follow-up?',
            style: TextStyle(
              fontSize: 14.0,
